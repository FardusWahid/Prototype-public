...
export default function PricingSectionCards() {
  ...
  return (
    <div
      id="pricing"
      className="container mx-auto px-4 md:px-6 2xl:max-w-[1400px] py-24 lg:pb-32"
    >
      ...
      <div className="flex justify-center items-center ">
        ...
        <Label htmlFor="payment-schedule" className="relative ms-3">
          Annual
          <span className="absolute -top-10 pl-2 sm:pl-0  sm:-top-10 start-auto sm:-end-28">
            <span className="flex items-center">
              ...
              <Badge className="mt-3 uppercase">
                Save <span className="hidden sm:inline">up to</span> 10%
              </Badge>
            </span>
          </span>
        </Label>
